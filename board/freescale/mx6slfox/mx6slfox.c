...
#define I2C3_PAD_CTRL   (PAD_CTL_LVE | PAD_CTL_PUS_100K_PD | \
	PAD_CTL_SPEED_MED | PAD_CTL_DSE_40ohm | PAD_CTL_HYS | \
	PAD_CTL_ODE | PAD_CTL_SRE_SLOW)
...
int board_late_init(void)
{
	...
	setup_i2c(1, CONFIG_SYS_I2C_SPEED, 0x32, &i2c2_info);
	setup_i2c(2, CONFIG_SYS_I2C_SPEED, 0X10, &i2c3_info);
