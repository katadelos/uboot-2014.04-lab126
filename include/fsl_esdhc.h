...
/* Initialization value for VENDORSPEC for different signal voltages */
#define VENDORSPEC_INIT_330		0x20007809
#define VENDORSPEC_INIT_180		0x2000780B
...
#define ESDHC_VOLTAGE_330		0
#define ESDHC_VOLTAGE_180		1
