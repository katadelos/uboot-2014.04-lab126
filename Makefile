...
install:
	...
	install -m 644 u-boot.bin /targets/$(shell sb-conf cu)/$(TARGET)/u-boot.bin
	install -m 644 u-boot.prod.bin /targets/$(shell sb-conf cu)/$(TARGET)/u-boot.prod.bin
	install -m 644 u-boot.bist.bin /targets/$(shell sb-conf cu)/$(TARGET)/u-boot.bist.bin
	install -m 644 u-boot.mfgtool.bin /targets/$(shell sb-conf cu)/$(TARGET)/u-boot.mfgtool.bin
	install -d /usr/local/bin
	install -m 755 tools/mkimage /usr/local/bin/mkimage
