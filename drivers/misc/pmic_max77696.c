...
static void setup_regulators(void)
{
	...
	if (BOARD_REV_GREATER(rev, BOARD_ID_WARIO_2)||
	    ...
	    BOARD_IS_(rev, BOARD_ID_ICEWINE_WARIO_512, BOARD_ID_N) || 
	    BOARD_IS_(rev, BOARD_ID_ICEWINE_WFO_WARIO_512, BOARD_ID_N) ||
	    BOARD_REV_GREATER(rev, BOARD_ID_ICEWINE_WARIO_EVT1_2) ||
	    BOARD_REV_GREATER(rev, BOARD_ID_ICEWINE_WFO_WARIO_EVT1_2) ||
...
int pmic_init(void) 
{
    ...
    /* Fox: Force UIC to man ctrl that draws 2.0A from any charging src
