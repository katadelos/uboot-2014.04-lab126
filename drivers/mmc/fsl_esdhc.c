...
static int esdhc_init(struct mmc *mmc)
{
	...
	/* Put VEND_SPEC to correct accordingly */
	if (cfg->signal_voltage == ESDHC_VOLTAGE_330) {
		/* Put VEND_SPEC to default value  with 3.3V signal voltage */
		esdhc_write32(&regs->vendorspec, VENDORSPEC_INIT_330);
	}
	else {
		/* ESDHC_VOLTAGE_180 - Put VEND_SPEC to use 1.8V signal voltage */
		esdhc_write32(&regs->vendorspec, VENDORSPEC_INIT_180);
	}
#endif
