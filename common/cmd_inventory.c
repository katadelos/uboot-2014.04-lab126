...
#ifdef CONFIG_EANAB
//	ret |= check_usbsw();       //remove this test since USB/UART will be removed from some of EANAB devices from DVT build and removed absolutely from PVT build by design
	ret |= check_touch();
#endif
	if(ret){
